...
public class Registrierung implements Initializable {
	...
	/*
	 * Der Code den Philipp geschrieben hat, wurde komplett in die Proxy-Klasse
	 * uebertragen. Dort findet die Ueberpruefung statt, und es wird dann die
	 * jeweilige Kontoklasse erstellt.
	 */
	// zwichenzeitlich bis bessere Lösung gefunden ist
	int id = 5;
	 ...
	 * mit den Strings 'Realname' und 'Nickname'. Standardauswahl ist 'Name'.
	 * Fuegt einen ChangeListener hinzu, welcher je nach Auswahl in der
	 * Choice-Box unterschiedliche Elemente hinzufuegt.
	 */
	@Override
	public void initialize(URL url, ResourceBundle rb) {
		...
		choiceBox.setItems(FXCollections.observableArrayList("Realname",
				"Nickname"));
		choiceBox.getSelectionModel().select(0);
		choiceBox.setTooltip(new Tooltip(
				"Mit welchem Namen m�chtest du dich registrieren?"));
	...
	/**
	 * Schliesst die Registrierungsmaske und oeffnet die Loginmaske. IOException
	 * wird gefangen, falls login.fxml nicht geladen werden kann.
	 */
	@FXML
	...
	/**
	 * Schliesst die Registrierungsmaske und oeffnet das Hauptfenster der
	 * CodingSession.
	 */
	@FXML
