...
public class BFTest {
	...
	public static void main(String args[]){
		...
		BenutzerkontoNickname konto3 = new BenutzerkontoNickname("unknown2@me.org","passwortsicherheit","RichtigCoolerTyp",2);
		BenutzerkontoNickname konto4 = new BenutzerkontoNickname("unknown3@me.org","passwortsicherheit","KrasserTyp",2);
		em.persist(konto2);
		em.persist(konto3);
		em.persist(konto4);
